...
//	    if (sameAsFormer(businessentity))
//	      return ;
//	    //set new owner
//	    Businessentity oldBen = this.businessentity;
	    this.businessentity = businessentity;
	    //remove from the old owner
//	    if (oldBen!=null)
//	    	oldBen.setPerson(null);
//	    //set myself into new owner
//	    if (businessentity!=null)
//	    	businessentity.setPerson(this);
	}
	
//	 private boolean sameAsFormer(Businessentity businessentity) {
//	    if (this.businessentity == null)
//	      return businessentity == null;
//	    
//	    return this.businessentity.equals(businessentity);
//	  }
